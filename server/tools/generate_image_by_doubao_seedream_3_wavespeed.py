...
@tool("generate_image_by_doubao_seedream_3_wavespeed",
...
async def generate_image_by_doubao_seedream_3_wavespeed(
    prompt: str,
    aspect_ratio: str,
...
__all__ = ["generate_image_by_doubao_seedream_3_wavespeed"]
